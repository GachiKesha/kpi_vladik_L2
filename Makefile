...
pkgdatadir = $(datadir)/donk
pkgincludedir = $(includedir)/donk
pkglibdir = $(libdir)/donk
pkglibexecdir = $(libexecdir)/donk
...
am__v_CCLD_1 = 
SOURCES = $(donk_SOURCES)
DIST_SOURCES = $(donk_SOURCES)
...
CXXFLAGS = -g -Wall 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"donk\" -DPACKAGE_TARNAME=\"donk\" -DPACKAGE_VERSION=\"1.0\" -DPACKAGE_STRING=\"donk\ 1.0\" -DPACKAGE_BUGREPORT=\"a@gmail.com\" -DPACKAGE_URL=\"\" -DPACKAGE=\"donk\" -DVERSION=\"1.0\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
OBJEXT = o
PACKAGE = donk
PACKAGE_BUGREPORT = a@gmail.com
PACKAGE_NAME = donk
PACKAGE_STRING = donk 1.0
PACKAGE_TARNAME = donk
PACKAGE_URL = 
PACKAGE_VERSION = 1.0
PATH_SEPARATOR = :
SET_MAKE = 
